...
cars_data <- read.csv("C:\\Users\\harsh\\Desktop\\Introduction to Machine learning and Data Mining\\Practicum-2\\car_data.csv",stringsAsFactors = TRUE)
...
for (i in c(1,2,4,5,6,7,8,9))
  {
    ...
    zscore <- (cars_outlier[,i]-mean_data)/sd_data
...
cars_pred <- lm(Price~.,data = cars_data)
summary(cars_pred)
